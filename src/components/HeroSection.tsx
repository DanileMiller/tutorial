      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Versatile developer with 10+ years of experience building high-performance frontend applications and AI-powered automation systems. Specialized in React, Next.js, GSAP, WebGL/Three.js to create immersive, animation-rich, and SEO-optimized web experiences. Proven track record in delivering interactive dashboards, 3D configurators, and WordPress solutions while ensuring Core Web Vitals and accessibility compliance.
            </motion.p>
